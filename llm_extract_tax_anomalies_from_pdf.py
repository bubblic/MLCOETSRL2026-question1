"""
Identify relevant Form 10-K pages, then extract tax anomaly/contingency JSON.

Example usage:
  python llm_extract_tax_anomalies_from_pdf.py --input-file "./annual_reports/google_2024.pdf"
...
from llm_pdf_pages_identifier import extract_json_from_text, select_pages_with_llm
