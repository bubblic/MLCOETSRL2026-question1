...
This module wires together the extraction, ratio-computation, and
hallucination-analysis pipelines behind a single ``argparse``-based
...
from financial_forecast.extraction.statement_extraction import run_extraction_pipeline
from financial_forecast.extraction.statement_hallucination import run_hallucination_analysis
...
from financial_forecast.extraction.statement_runs import list_run_dirs, resolve_output_path
