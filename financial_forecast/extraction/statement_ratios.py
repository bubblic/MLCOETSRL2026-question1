...
This module computes derived financial metrics (EBIT, EBITDA, quick assets,
etc.) and standard ratios (debt-to-equity, interest coverage, etc.) from
normalized statement data.  It supports both single-directory and
median-across-runs aggregation modes.
"""
...
from financial_forecast.extraction.statement_normalization import sanitize_filename, statement_period_to_single_values
