...
This module orchestrates the end-to-end extraction pipeline: reading raw
statement files, sending them to the Azure LLM endpoint, normalizing the
responses, and writing the structured output to disk.
"""
...
from financial_forecast.extraction.statement_normalization import build_prompt, load_raw_statement, normalize_periods
