"""Run the financial model with cash-target liquidity.
...
Usage:
    python run_trainable_model_forecast_cashtarget.py
"""
...
if __name__ == "__main__":
    ...
    ForecastPipeline(
        ...
        parameters_save_path="trained_parameters_cashtarget.npz",
